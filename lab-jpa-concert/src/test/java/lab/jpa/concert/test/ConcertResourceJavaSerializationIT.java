...
import lab.jpa.concert.services.SerializationMessageBodyReaderAndWriter;
 ...
 */
public class ConcertResourceJavaSerializationIT {

    private static Logger LOGGER = LoggerFactory.getLogger(ConcertResourceJavaSerializationIT.class);
    ...
    public static void createClient() {
        ...
        client.register(SerializationMessageBodyReaderAndWriter.class);
    ...
    public void clearAndPopulate() {
        ...
        for (Concert concert : concerts) {
            ...
            addCookieToInvocation(builder);
            response = builder.post(Entity.entity(concert, "application/java-serialization"));
            processCookieFromResponse(response);
    ...
    public void testRetrieve() {
        ...
        try {
            ...
            Builder builder = client.target(concertUri).request().accept("application/java-serialization");
